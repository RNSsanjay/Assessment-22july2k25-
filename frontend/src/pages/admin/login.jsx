  ...
  const handleSignIn = async (e) => {
    ...
    try {
      const response = await fetch('http://127.0.0.1:8000/api/admin/login/', {
        ...
        credentials: 'include', // Allow cookies for CSRF
      });
    ...
    <div className="min-h-screen flex font-inter">
      ...
      <div className="w-full md:w-3/5 bg-[#F5F5F7] p-8 md:p-12 flex flex-col justify-center">
        <div className="max-w-md mx-auto w-full">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-[#2C2C2C] mb-8 text-center">Sign In to Event Hive</h2>
          <form className="space-y-6" onSubmit={handleSignIn}>
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <label htmlFor="password" className="block text-[#6C6C6C] text-sm font-bold uppercase tracking-wide">
                  Password
                </label>
                <a href="#" className="text-[#8A2BE2] text-sm font-medium hover:underline">
